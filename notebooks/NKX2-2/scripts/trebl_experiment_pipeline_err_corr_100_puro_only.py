...
pipeline_err_corr = pipelines.TreblPipeline(
    db_path = "/global/scratch/projects/fc_mvslab/OpenProjects/Sanjana/TREBL/duckdb/NKX2-2_TL4B2_err_corr_100_puro_only.db", # CHANGE TO DUCKDB LOCATION
    design_file_path = "/global/scratch/projects/fc_mvslab/OpenProjects/Sanjana/TREBL/data/DNA_Tiles_nkx2_2.txt", 
    error_correction = True,  
    output_path = "/global/scratch/projects/fc_mvslab/OpenProjects/Sanjana/TREBL/output/NKX2-2/TL4B2/puro_only/err_corr_100")  # CHANGE TO DESIRED OUTPUT, FOLDER MUST EXIST

# Input sequence files
AD_seq_files = glob.glob("/global/scratch/projects/fc_mvslab/OpenProjects/Caitlin/TL4B2/puro_only/a*fastq") # CHANGE TO CORRECT PATHS
RT_seq_files = glob.glob("/global/scratch/projects/fc_mvslab/OpenProjects/Caitlin/TL4B2/puro_only/r*fastq") # CHANGE TO CORRECT PATHS
...
pipeline_err_corr.trebl_experiment_analysis(
        ...
        reads_threshold_AD=100,      # Threshold of 1 because auto detection of threshold
        reads_threshold_RT=100,       # Threshold of 1 because auto detection of threshold
    )