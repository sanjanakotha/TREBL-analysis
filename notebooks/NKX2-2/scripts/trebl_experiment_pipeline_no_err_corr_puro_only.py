...
pipeline_no_err_corr = pipelines.TreblPipeline(
    db_path = "/global/scratch/projects/fc_mvslab/OpenProjects/Sanjana/TREBL/duckdb/NKX2-2_TL4B2_no_err_corr_puro_only.db", # CHANGE TO DUCKDB LOCATION
    design_file_path = "/global/scratch/projects/fc_mvslab/OpenProjects/Sanjana/TREBL/data/DNA_Tiles_nkx2_2.txt", 
    error_correction = False,  
    output_path = "/global/scratch/projects/fc_mvslab/OpenProjects/Sanjana/TREBL/output/NKX2-2/TL4B2/puro_only/no_err_corr")  # CHANGE TO DESIRED OUTPUT, FOLDER MUST EXIST
