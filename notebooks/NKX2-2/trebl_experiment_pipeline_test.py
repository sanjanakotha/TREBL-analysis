...
pipeline_auto_err_corr = pipelines.TreblPipeline(
    db_path = "../../duckdb/NKX2-2_pipeline_test_err_corr_new_data.db", # CHANGE TO DUCKDB LOCATION
    design_file_path = "/global/scratch/projects/fc_mvslab/OpenProjects/Sanjana/TREBL/data/DNA_Tiles_nkx2_2.txt", 
    error_correction = True,  
    output_path = "/global/scratch/projects/fc_mvslab/OpenProjects/Sanjana/TREBL/output/NKX2-2/pipeline_test/new_data_test")  # CHANGE TO DESIRED OUTPUT, FOLDER MUST EXIST
...
trebl_exp_results_auto_err_corr = pipeline_auto_err_corr.trebl_experiment_analysis(
        ...
        reads_threshold_AD=1,      # Threshold of 1 because auto detection of threshold
        reads_threshold_RT=1       # Threshold of 1 because auto detection of threshold
    )