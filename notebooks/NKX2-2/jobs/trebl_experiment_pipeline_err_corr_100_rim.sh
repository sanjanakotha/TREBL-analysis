#!/bin/bash
#SBATCH --job-name=trebl_experiment_pipeline_err_corr_100_rim
#SBATCH --account=fc_mvslab
#SBATCH --partition=savio2
#SBATCH --nodes=1
#SBATCH --cpus-per-task=24
#SBATCH --time=48:00:00
#SBATCH --output=/global/scratch/projects/fc_mvslab/OpenProjects/Sanjana/TREBL/notebooks/NKX2-2/logs/trebl_experiment_pipeline_err_corr_100_rim_%j.out
