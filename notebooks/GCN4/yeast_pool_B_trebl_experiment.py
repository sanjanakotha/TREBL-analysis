...
print(f"Found {len(yeast_pool_B_AD_seq_files)} AD files")
print(f"Found {len(yeast_pool_B_RT_seq_files)} RPTR files")

# Output directory for processed results
yeast_pool_B_output_path = "/global/scratch/projects/fc_mvslab/OpenProjects/Sanjana/TREBL/output/GCN4/yeast_pool_B"
os.makedirs(yeast_pool_B_output_path, exist_ok=True)
print(f"Output path: {yeast_pool_B_output_path}")
