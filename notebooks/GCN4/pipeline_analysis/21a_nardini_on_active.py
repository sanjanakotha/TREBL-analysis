...
OUTPUT_DIR = "/global/scratch/projects/fc_mvslab/OpenProjects/Sanjana/TREBL/output/GCN4_pipeline/speed/NARDINI"

def process_seq(args):
    idx, seq = args
    try:
        os.chdir(OUTPUT_DIR)  # Each worker needs to set cwd
...
def main():
    ...
    # Use all available CPUs (Savio gives you what you request in the job script)
    n_workers = cpu_count()
