...
from trebl_tools import initial_map
from trebl_tools import map_refiner
from trebl_tools import complexity
from trebl_tools import finder
from trebl_tools import preprocess
from trebl_tools import plotting
import os
from tqdm import tqdm
from trebl_tools import umi_deduplicate

print("Done with imports")

# Input and output paths
yeast_pool_C_umi_AD_seq_files = glob.glob(
    "/global/scratch/projects/fc_mvslab/data/sequencing/20250218_MZCCSCU_MedGenome/MZ/results/assembled/*"
)
...
db_path = (
    "/global/scratch/projects/fc_mvslab/OpenProjects/Sanjana/TREBL/duckdb/GCN4_final.db"
)
...
for file_path in yeast_pool_C_umi_AD_seq_files:
    ...
    umi_path = os.path.join(
        yeast_pool_C_umi_output_path, f"trebl_experiment_yeast_pool_C_umi_{name_only}"
    )
